...
export default function Herotoo() {
    ...
    return (
        <section className="relative h-full w-full text-foreground flex items-center bg-[#FDF4AF] overflow-hidden">
        <div 
        ...
        />
            <div className="w-full h-full px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
                ...
                <div className="space-y-8 z-10 p-14 rounded-3xl">
                    <h1 className={`${fraunces.className} text-5xl md:text-9xl font-extrabold leading-tight`}>
                        Swit60 Homestay
                    </h1>
                    ...
                    <Button
                        className="px-6 py-3 text-lg transition-all duration-300 hover:scale-105 hover:bg-primary/90 hover:shadow-lg"
                        onClick={handleClick}
                    >
                        Book Now
                    </Button>
                ...
                <div className="h-full w-full flex items-center justify-center">
                    <Image
                        ...
                        width={320}
                        height={320}
                        className="w-auto h-auto" // Ensures it's responsive
                    />
                </div>
            </div>
        </section>
